            ...
            <div className="md:grid px-4 w-full md:grid-cols-9 grid-rows-1 gap-4 mt-12">
                <div className=" md:col-span-6 grid gap-2">
                    ...
                    {cart.cart.map(product => (
                        ...
                        <div key={product.id} className="grid grid-cols-3 md:grid-cols-7 grid-row-2 md:grid-rows-1 gap-2 border border-gray-200 rounded-lg h-20 items-center">
                            <div className='p-1.5 '>
                            ...
                            <div className="row-start-2 md:col-start-4 flex justify-end">
                            ...
                            <div className="row-start-2 md:col-start-5 flex justify-end">${product.price}</div>
                            <div className="row-start-2 md:col-start-6 flex justify-end">${Number(product.price * product.totalItem).toFixed(2)}</div>
                            <div className="row-start-2 md:col-start-7 flex justify-center"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x" viewBox="0 0 16 16">
